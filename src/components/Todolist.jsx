...
export const Todolist = () => {
  const [todayList, updateTodayList] = useState([
    "Change Theme Colors",
    "Review with Dev Team",
    "Finaize Slider Component",
    "Celebrate Release",
  ]);
    ...
    <div className="container">
      ...
      <div className="second">
        <div className="inner">
          ...
          <button
            className="arrange format"
            onClick={(e) => {
              e.preventDefault();

              if (inputValue) {
                var lowerWord = inputValue.toLowerCase();
                var check = todayList.some(
                  (today) => today.toLowerCase() === lowerWord
                );
          ...
          <ul className="secondList">
            ...
            choresDone.length === 0 && <p>No Completed Tasks</p>
                ...
                return (
                  <div className="arrange" key={index}>
                    <div
                      className="circle"
                      onClick={() => {
                        var keep = choresDone.filter(
                          (chores) => chores !== moveDown
                        );
